"""RazorpayAdapter — Payment gateway transaction records."""
...
class RazorpayAdapter(BaseSourceAdapter):
    """Fetches normalized records from the Razorpay transactions source."""
    ...
    def fetch_records(self) -> list[Record]:
        return self._backend.fetch_records("razorpay")
